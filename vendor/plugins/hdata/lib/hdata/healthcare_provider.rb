  ...
  module Translation
    module HealthcareProvider
      ...
      def to_hdata(xml)
        ...
        xml.provider(:xmlns => "http://projecthdata.org/hdata/schemas/2009/06/healthcare_provider",
              "xmlns:core" => Hdata::Core::NAMESPACE) do
          attrs = {}
          attrs[:low] = start_service.to_s if start_service.present?
          attrs[:high] = end_service.to_s if end_service.present?          
          ...
          if provider_role
            ...
            xml.providerRoleFreeText provider_role.free_text
          end
          if provider_type
            xml.providerType("code" => provider_type.code,
                     "displayName" => provider_type.name,
                     "codeSystem" => "2.16.840.1.113883.6.101",
                     "codeSystemName" => 'ProviderCodes')
          end
          xml.providerEntity do
            Hdata::Cre::PersonLike.to_hdata(self,xml)
          end
